<x-app-layout>
    ...
    <body>
        <h1 class="text-4xl font-bold mb-2 text-white">Registrar pelicula</h1>
        <form action="{{route('pelicula.store')}}" method="POST">
            ...
            <DIV>
                ...
                <input type="text" name="artistas_principales" id="artistas_principales" class="block w-medium mx-auto p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                <label for="año" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">año</label>
                <input type="number" name="año" id="año" class="block w-medium mx-auto p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                <label for="productora" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">productora</label>
                <input type="text" name="productora" id="productora" class="block w-medium mx-auto p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                <label for="genero" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">genero</label>
                <input type="text" name="genero" id="genero" class="block w-medium mx-auto p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
